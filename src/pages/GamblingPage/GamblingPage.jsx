                            ...
                            if (!isSeriesOver) {
                                ...
                                seriesApplyTimeoutRef.current = setTimeout(() => {
                                    ...
                                    if (pending.newPoints >= goalPoints) {
                                        setIsWin(true);
                                        setTimeout(() => setShowGameOverScreen(true), 3000);
                        ...
                        <div className={css.intro_content} style={{ maxHeight: "85vh", overflowY: "auto" }}>
                            {seriesModeDraft !== "special" ? (
                                ...
                                <p
                                    ...
                                    style={{ fontSize: "20px", margin: "0", textAlign: "center", maxWidth: "60ch" }}
                                    >
                                    In Special Mode, win streak is not available...
                                </p>
                            )}
                            ...
                            <div className={css.mode_select_container} style={{ marginTop: 20 }}>
                                ...
                                <div className={css.mode_buttons}>
                                    ...
                                    <button
                                        className={`${css.gamble_button} ${seriesModeDraft === "special" ? css.active_mode : ""}`}
                                        onMouseEnter={(e) => {
                                            const rect = e.currentTarget.getBoundingClientRect();
                                            setTooltipCoords({ top: rect.top + rect.height / 2, left: rect.right + 10 });
                                            setHoveredMode("special");
                                        }}
                                        onMouseLeave={() => setHoveredMode(null)}
                                        onClick={() => setSeriesModeDraft("special")}
                                    >
                                        Special
                                    </button>
                                </div>
                                ...
                                {hoveredMode === "special" && (
                                    ...
                                    >
                                        ...
                                        This a tournament-like mode where 64 teams in a tournament compete in series from Extended Mode. <br />
                            ...
                            {seriesModeDraft && seriesModeDraft !== "special" && (
                                <>
                            ...
                            {seriesModeDraft === "special" && (
                                <p className={css.info_text} style={{ marginTop: "12px" }}>
                                    No difficulty needed — pressing "Let's go!" will activate Special Mode even though there's no difficulty selected.
                                </p>
                            )}

                            <button
                                className={`${css.proceed_button} ${seriesModeDraft === "special" ? "" : (!difficulty || !seriesModeDraft ? css.locked : "")}`}
                                onClick={() => {
                                    if (seriesModeDraft === "special") {
                                        setShowDifficultyOverlay(false);
                                ...
                                disabled={seriesModeDraft === "special" ? false : (!difficulty || !seriesModeDraft)}
                                style={{ marginTop: 20 }}
                            >
                                Let's go!
                            </button>
                        ...
                        <div className={css.intro_content}>
                            ...
                            <div className={css.fade_in}>
                                ...
                                <div className={`${css.points} ${css.slide_in_left}`}>
                                    <CountUp start={0} end={currentPoints} duration={1.2} key={currentPoints} />
                                </div>
                            </div>
                            ...
                            <div className={css.fade_in_delay}>
                                ...
                                <div className={`${css.points} ${css.slide_in_left}`}>
                                    <CountUp start={0} end={goalPoints} duration={1.2} key={goalPoints} />
                                </div>
                            </div>
